...
**
** Created: Sat May 1 23:42:23 2010
...
static const uint qt_meta_data_smallTutwin[] = {
...
static const char qt_meta_stringdata_smallTutwin[] = {
    "smallTutwin\0"
};

const QMetaObject smallTutwin::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_smallTutwin,
      qt_meta_data_smallTutwin, 0 }
};

const QMetaObject *smallTutwin::metaObject() const
{
    return &staticMetaObject;
}

void *smallTutwin::qt_metacast(const char *_clname)
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_smallTutwin))
        return static_cast<void*>(const_cast< smallTutwin*>(this));
    return QWidget::qt_metacast(_clname);
}

int smallTutwin::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    _id = QWidget::qt_metacall(_c, _id, _a);
    if (_id < 0)
        return _id;
